...
| Variations multi-périodes | Pour chaque valeur : veille, 1 semaine, 1 mois, 3 mois, 6 mois, année en cours, 1 an, 3 ans, 5 ans, calculées sur les clôtures et recalculées à chaque cotation ; fourchette 52 semaines ; sélecteur de période sur la cote |
| Ergonomie | Barre latérale par domaines (Conseil, Patrimoine, Marché, Compte), recherche globale ⌘K / Ctrl+K (valeurs et pages), états de chargement, tiroir de navigation mobile, focus clavier visible, respect de « réduire les animations » |
